...
-- name: DeleteVotesByUserID :exec
DELETE FROM votes WHERE user_id = $1 RETURNING *;

-- name: DeleteVotesByUserIDAndPollID :exec
DELETE FROM votes WHERE user_id = $1 AND poll_id = $2 RETURNING *;
